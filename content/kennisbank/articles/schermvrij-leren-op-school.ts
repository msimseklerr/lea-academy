...
const article: Article = {
  ...
  description:
    "Schermvrij leren op school: waarom tactiele technieklessen 21e-eeuwse vaardigheden versterken en hoe u als school de balans met digitaal vindt.",
  category: "Voor scholen",
  readTime: "11 min",
  image: "https://images.unsplash.com/photo-1491897554428-130a60dd4757?w=900&q=80",
  imageAlt: "Handen van een kind die nauwkeurig kleine technische onderdelen in elkaar monteren, zonder scherm in beeld",
  intro:
  ...
  faqs: [
    {
      question: "Is schermvrij leren hetzelfde als 'geen technologie gebruiken'?",
      answer:
    ...
    {
      question: "Gaat schermvrij leren ten koste van digitale vaardigheden bij leerlingen?",
      answer:
    ...
    {
      question: "Hoeveel extra lesrooster kost het invoeren van meer schermvrij technieklesaanbod?",
      answer:
    ...
    {
      question: "Is schermvrij leren geschikt voor alle leerjaren, van groep 3 tot 8?",
      answer:
    ...
    {
      question: "Hoe weet ik of een externe aanbieder daadwerkelijk schermvrij lesgeeft?",
      answer:
    ...
    {
      question: "Wat is het verschil tussen schermvrij leren en unplugged coding?",
      answer:
  ...
  furtherReading: [
    ...
    { slug: "creativiteit-en-techniek-klas", title: "Creativiteit en techniek combineren in de klas: praktische ideeën" },
