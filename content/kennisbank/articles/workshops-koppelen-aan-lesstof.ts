...
const article: Article = {
  slug: "workshops-koppelen-aan-lesstof",
  title: "Workshops koppelen aan je lesstof: geschiedenis, biologie en cultuur met techniek",
  description: "Hoe koppel je een techniekworkshop aan geschiedenis, biologie of cultuur? Praktische aanpak en voorbeelden voor een workshop op maat school.",
  category: "Voor scholen",
  readTime: "11 min",
  image: "/images/workshops/windmolen-speelgoed.png",
  imageAlt: "Kinderen spelen met een zelfgemaakt draaiend windmolentje tijdens een schoolworkshop over Nederlandse cultuur en techniek",
  intro:
  ...
  tables: [
    ...
    {
      title: "Stappenplan: een workshop koppelen aan uw lesstof",
      headers: ["Stap", "Actie", "Waarom belangrijk"],
      rows: [
  ...
  checklist: {
    title: "Checklist: uw vak koppelen aan een techniekworkshop",
    items: [
      "Benoem het concrete lesdoel dat u met de workshop wilt versterken.",
      "Zoek een tastbaar mechanisme, proces of object dat bij dat lesdoel past.",
      "Vraag de aanbieder expliciet naar de mogelijkheden voor maatwerk, niet alleen naar het standaardaanbod.",
      "Bespreek het niveau en de al aanwezige voorkennis van uw groep.",
      "Leg vast of de workshop vooraf (introductie) of achteraf (verdieping) in uw lesprogramma past.",
      "Deel vaktermen en achtergrondinformatie die leerlingen al hebben gehad met de begeleider.",
      "Vraag na of de workshop schermvrij en tastbaar is opgezet, passend bij uw vak.",
      "Bekijk of het bredere workshopaanbod nog meer koppelingen biedt voor andere vakken dit jaar.",
      "Evalueer na afloop met uw team of het lesdoel is behaald.",
    ],
  },
  observation:
  ...
  faqs: [
    {
      question: "Kan elke workshop worden aangepast aan onze specifieke lesstof, of alleen een select aantal?",
      answer:
        "De meeste workshops uit het aanbod van bijna 200 originele atelierworkshops bieden ruimte voor aanpassing aan een specifiek thema of vak, al verschilt de mate van maatwerk per workshop. Het is daarom altijd zinvol om uw lesdoel en thema vooraf te bespreken, zodat de begeleider kan aangeven welke aanpassingen mogelijk zijn.",
    },
    {
      question: "Zijn de voorbeelden van Da Vinci's leeuw, Heron's stoomdeuren en de windmolen ook geschikt voor jongere groepen?",
      answer:
        "Ja, deze thema's kunnen in vereenvoudigde vorm ook bij jongere groepen worden ingezet, met een eenvoudiger mechanisme en meer begeleiding, terwijl oudere groepen een complexere versie en meer historische of technische verdieping aankunnen. De kern van de koppeling — zelf een historisch of natuurkundig principe naspelen — blijft bij elke leeftijd hetzelfde.",
    },
    {
      question: "Moeten wij als school zelf de vakinhoudelijke link uitwerken, of doet de workshopaanbieder dat?",
      answer:
        "Bij Little Engineers Academy denken de begeleiders actief mee over de koppeling, maar het werkt het beste als de school vooraf het lesdoel en de context aanlevert. Zo kan de workshop echt worden afgestemd op wat er al in de klas is behandeld, in plaats van een losse aanvulling te blijven.",
    },
    {
      question: "Is een technische workshop niet vooral geschikt voor exacte vakken, en minder voor geschiedenis of cultuur?",
      answer:
        "Nee, dat is een misvatting. Techniek is in de kern een manier van denken en bouwen die evengoed op geschiedenis, biologie of cultuur toepasbaar is als op wiskunde of natuurkunde, zoals de voorbeelden van Da Vinci's mechanische leeuw en de Nederlandse windmolen laten zien.",
    },
    {
      question: "Hoeveel tijd moeten we vooraf inplannen om een workshop goed aan onze lesstof te koppelen?",
      answer:
        "Een kort gesprek met de workshopaanbieder over lesdoel, thema en niveau is meestal voldoende, en kan enkele weken voor de geplande workshopdatum plaatsvinden. Hoe eerder u het gewenste thema deelt, hoe meer ruimte er is om de workshop daadwerkelijk op maat te maken.",
    },
    {
      question: "Werkt deze aanpak ook voor een eenmalige projectweek, of alleen voor structurele samenwerking?",
      answer:
        "De aanpak werkt in beide situaties: ook binnen een eenmalige projectweek kan een workshop gericht op een specifiek thema worden ingezet. Bij een langere samenwerking is er wel meer ruimte om de koppeling over meerdere workshops en vakken heen op te bouwen en te verdiepen.",
    },
  ],
  ...
  furtherReading: [
    ...
    { slug: "steam-workshops-basisonderwijs-gids", title: "STEAM-workshops voor het basisonderwijs: de complete gids voor leerkrachten" },
  ],
};
