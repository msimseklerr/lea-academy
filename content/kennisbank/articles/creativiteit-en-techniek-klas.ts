...
const article: Article = {
  ...
  title: "Creativiteit en techniek combineren in de klas: praktische ideeën",
  description:
    "Praktische ideeën voor een creatieve workshop klas: bouw met afvalmateriaal, LED-circuits en ontwerpuitdagingen die techniek en creativiteit samenbrengen.",
  category: "Voor scholen",
  readTime: "10 min",
  image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&q=80",
  imageAlt: "Meisje programmeert zelfstandig haar robot met een grote glimlach",
  intro:
  ...
  tables: [
    ...
    {
      title: "Klasactiviteit zelf uitvoeren versus een professionele workshop: wat verschilt er?",
      headers: ["Aspect", "Zelf in de klas", "Professionele workshop"],
      rows: [
  ...
  checklist: {
    title: "Checklist: een creatieve technische activiteit organiseren in de klas",
    items: [
      "Verzamel afvalmateriaal (wc-rollen, karton, doppen) minstens twee weken van tevoren, eventueel via ouders.",
      "Verdeel de klas in groepjes van drie tot vier leerlingen met een duidelijke rolverdeling.",
      "Laat leerlingen eerst schetsen voordat ze daadwerkelijk gaan bouwen.",
      "Stel per activiteit één technisch leerdoel en één creatief leerdoel vooraf vast.",
      "Zorg voor reserve-LED's en batterijen bij elektronica-opdrachten.",
      "Plan minimaal een dubbel lesuur in voor schetsen, bouwen en testen.",
      "Bouw een testmoment in waarin leerlingen hun ontwerp mogen bijstellen.",
      "Laat leerlingen hun ontwerp of constructie kort toelichten aan de klas.",
      "Maak foto's van het proces voor reflectie, een nieuwsbrief of ouderavond.",
      "Overweeg een externe workshop zodra materiaal, tijd of technische kennis te beperkt wordt.",
    ],
  },
  observation:
  ...
  faqs: [
    {
      question: "Kan ik deze activiteiten zonder technische achtergrond zelf begeleiden in de klas?",
      answer:
        "Ja, alle activiteiten in dit artikel zijn bewust zo gekozen dat er geen technische vooropleiding nodig is. Een eenvoudig LED-circuit met een knoopcelbatterij en koperplakband bijvoorbeeld, is binnen enkele minuten te begrijpen en veilig uit te leggen aan leerlingen, ook zonder eigen technische achtergrond.",
    },
    {
      question: "Hoeveel tijd kost het om een creatieve technische activiteit voor te bereiden?",
      answer:
        "Reken op een half uur tot een uur voorbereiding voor het verzamelen en klaarleggen van materiaal, plus minimaal een dubbel lesuur voor de activiteit zelf. Activiteiten met afvalmateriaal vragen meestal iets meer voorbereidingstijd omdat je materiaal moet verzamelen, terwijl LED-opdrachten met kant-en-klaar materiaal sneller te organiseren zijn.",
    },
    {
      question: "Is het veilig om met LED's en batterijen te werken met jonge leerlingen?",
      answer:
        "Ja, mits je met lage-spanning materiaal werkt zoals een LED-lampje en een platte knoopcelbatterij, en je toezicht houdt bij het uitdelen en inzamelen van de batterijen. Wijs leerlingen erop dat een batterij nooit in de mond mag, en houd bij jonge kinderen extra toezicht tijdens de opdracht.",
    },
    {
      question: "Wat doe ik als het materiaal voor een activiteit niet toereikend is voor de hele klas?",
      answer:
        "Werk in dat geval in kleinere groepjes die om de beurt aan de slag gaan, of pas de opdracht aan naar een gedeelde constructie per groepje in plaats van een individueel werkstuk. Vraag ook tijdig ouders om aanvullend afvalmateriaal mee te geven; dit levert vaak meer materiaal op dan zelf inkopen.",
    },
    {
      question: "Wanneer is het slimmer om een professionele workshop in te schakelen in plaats van het zelf te doen?",
      answer:
        "Zodra een activiteit meer specialistisch materiaal vraagt dan wc-rollen en LED's, zoals motoren, accu's of robotica-onderdelen, of wanneer je een workshop echt wilt koppelen aan een specifiek vak of thema, is professionele begeleiding meestal efficiënter dan het zelf uitzoeken. Een workshopbureau of technieklab zoals LEA neemt dan voorbereiding, materiaal en technische kennis volledig over.",
    },
    {
      question: "Hoe combineer ik deze activiteiten met bestaande lesdoelen, zodat het geen extra project wordt?",
      answer:
        "Koppel de activiteit aan een thema dat al op het programma staat, bijvoorbeeld een windmolen bij een aardrijkskundeles of een verhalend diorama bij taal of geschiedenis. Zo functioneert de activiteit als verdieping van bestaande lesstof in plaats van als losstaand extra project naast een toch al volle lesweek.",
    },
  ],
  relatedProgram: { href: "/voor-scholen", label: "Voor scholen — ons aanbod" },
  furtherReading: [
    { slug: "schermvrij-leren-op-school", title: "Schermvrij leren op school: waarom en hoe?" },
    { slug: "workshop-op-maat-vs-standaard", title: "Workshop op maat vs. standaardworkshop: wat past bij jouw klas?" },
    { slug: "workshops-koppelen-aan-lesstof", title: "Workshops koppelen aan je lesstof: geschiedenis, biologie en cultuur met techniek" },
  ],
};
