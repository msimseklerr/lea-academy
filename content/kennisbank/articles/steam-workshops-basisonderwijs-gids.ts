...
const article: Article = {
  ...
  description:
    "Complete gids over STEAM onderwijs basisschool: wat het inhoudt, hoe het aansluit op de W&T-kerndoelen en hoe scholen het structureel invoeren in de praktijk.",
  category: "Voor scholen",
  readTime: "13 min",
  image: "https://images.unsplash.com/photo-1509062522246-3755977927d7?w=900&q=80",
  imageAlt: "Basisschoolleerlingen luisteren aandachtig terwijl een begeleider een STEM-uitleg geeft",
  intro:
  ...
  tables: [
    ...
    {
      title: "W&T in het curriculum: kerndoeldomein en praktische invulling",
      headers: ["Kerndoeldomein", "Waar het om draait", "Praktische invulling met STEAM"],
      rows: [
    ...
    {
      title: "Categorieën STEAM-aanbieders vergeleken",
      headers: ["Categorie", "Sterke punten", "Aandachtspunten"],
      rows: [
  ...
  checklist: {
    title: "Checklist: STEAM structureel invoeren op je school",
    items: [
      "Wijs een techniekcoördinator aan met echte tijd in het takenbeleid, niet alleen in naam.",
      "Kies bewust voor losse lessen, een doorlopende leerlijn of een combinatie, in plaats van het aan het toeval over te laten.",
      "Koppel STEAM-activiteiten expliciet aan de W&T-kerndoelen in het schoolplan.",
      "Begin klein: één vast STEAM-moment per twee weken in een paar groepen is beter dan één groot, kortstondig project.",
      "Zorg voor een vaste, makkelijk toegankelijke opslagplek voor materialen.",
      "Betrek collega's die zich onzeker voelen bij techniek actief, bijvoorbeeld via korte updates in het teamoverleg.",
      "Vraag bij een externe partner altijd of workshops kunnen aansluiten bij de actuele lesstof.",
      "Maak leerlingprojecten zichtbaar in de school, bijvoorbeeld tijdens een ouderavond of in de hal.",
      "Verzamel korte terugkoppeling van leerkrachten na elke STEAM-les of themaweek.",
      "Evalueer jaarlijks of de leerlijn wordt uitgebreid, aangepast of verstevigd.",
    ],
  },
  observation:
  ...
  faqs: [
    {
      question: "Is STEAM-onderwijs verplicht op de basisschool?",
      answer:
        "STEAM zelf is geen apart verplicht vak, maar de onderliggende W&T-kerndoelen binnen het domein Oriëntatie op jezelf en de wereld zijn wel onderdeel van het verplichte curriculum. STEAM-activiteiten zijn een praktische, aantoonbare manier om aan die kerndoelen te werken, wat scholen ook kunnen laten zien richting inspectie en bestuur.",
    },
    {
      question: "Hoeveel tijd moet een school wekelijks aan STEAM besteden?",
      answer:
        "Er is geen wettelijk vastgesteld minimum aantal uren. In de praktijk werkt een vast moment van ongeveer een uur per twee weken per groep goed als basis voor een doorlopende leerlijn, aangevuld met incidentele lessen of een jaarlijkse themaweek.",
    },
    {
      question: "Kan STEAM ook zonder eigen technieklokaal of dure apparatuur?",
      answer:
        "Ja. Veel STEAM-activiteiten op de basisschool zijn schermvrij en gebruiken eenvoudige, herbruikbare materialen zoals karton en elementaire bouwsets. Een eigen technieklokaal of geavanceerde apparatuur is een mooie stap vooruit, maar zeker geen voorwaarde om te beginnen.",
    },
    {
      question: "Wat is het verschil tussen een techniekcoördinator en een externe STEAM-partner?",
      answer:
        "Een techniekcoördinator is een teamlid dat de STEAM-leerlijn intern bewaakt, collega's ondersteunt en materialen en partners coördineert. Een externe STEAM-partner verzorgt de daadwerkelijke workshops en brengt vakinhoudelijke expertise en materiaal mee. Veel scholen combineren beide: de coördinator regisseert, de externe partner voert een deel van de lessen uit.",
    },
    {
      question: "Hoe kies je tussen losse workshops en een doorlopende leerlijn?",
      answer:
        "Losse workshops zijn een goede, laagdrempelige start om te ontdekken wat aanslaat, maar leveren minder leerrendement op dan een doorlopende leerlijn omdat vaardigheden dan niet opbouwen. Voor structureel effect is het advies om na een aantal losse lessen door te groeien naar een vast, terugkerend STEAM-moment door het jaar heen.",
    },
    {
      question: "Wat maakt Little Engineers Academy anders dan een gewone workshopleverancier voor scholen?",
      answer:
        "LEA werkt met bijna 200 originele, grotendeels exclusieve atelierworkshops die worden aangepast aan de actuele lesstof van een school, gegeven door echte ingenieurs, kunstenaars en psychologen in plaats van willekeurige bijbaanstudenten. Met meer dan 150 scholen als partner en ruim 12.000 bereikte leerlingen sinds de oprichting in 2016 heeft LEA hier ruime ervaring in opgebouwd.",
    },
  ],
