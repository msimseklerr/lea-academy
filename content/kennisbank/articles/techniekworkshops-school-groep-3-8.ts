...
const article: Article = {
  slug: "techniekworkshops-school-groep-3-8",
  title: "Techniekworkshops op school: wat werkt écht voor groep 3 tot 8?",
  description:
    "Welke techniekworkshop past bij welke groep? Een praktische gids per leeftijdsfase over spanningsboog, groepsgrootte en opdrachttype voor groep 3-8.",
  category: "Voor scholen",
  readTime: "10 min",
  image: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=900&q=80",
  imageAlt: "Kinderen uit het basisonderwijs werken samen aan een technisch bouwproject in de klas",
  intro:
  ...
  tables: [
    ...
    {
      title: "Aanbevolen groepsgrootte en lesduur per leeftijdsfase",
      headers: ["Groep", "Aanbevolen groepsgrootte per begeleider", "Aanbevolen lesduur"],
      rows: [
  ...
  checklist: {
    title: "Checklist: een techniekworkshop kiezen die past bij de leeftijdsgroep",
    items: [
      "Vraag concreet hoe het programma verschilt tussen groep 3-4, 5-6 en 7-8, niet alleen of het 'aanpasbaar' is.",
      "Controleer of de opdracht past bij de spanningsboog van de leeftijdsgroep (korte stappen voor jonge kinderen, langere opdrachten voor oudere).",
      "Vraag naar de groepsgrootte per begeleider en of die per leeftijdsfase verschilt.",
      "Ga na of het materiaal past bij de fijne motoriek van de leeftijdsgroep (grote onderdelen voor groep 3-4, nauwkeuriger werk vanaf groep 5).",
      "Vraag of de workshop kan aansluiten op actuele lesstof zoals geschiedenis, biologie of aardrijkskunde.",
      "Informeer naar de achtergrond en opleiding van de lesgevers die daadwerkelijk voor de groep staan.",
      "Bepaal vooraf of je een eenmalige activiteit, een doorlopend traject of een projectweek wilt organiseren.",
      "Regel hoe de resultaten na afloop zichtbaar worden voor ouders en de rest van de school.",
      "Evalueer na de eerste sessie met de betrokken leerkrachten of moeilijkheidsgraad en begeleiding aansloten.",
    ],
  },
  observation:
  ...
  faqs: [
    {
      question: "Vanaf welke groep kunnen kinderen met programmeren beginnen tijdens een techniekworkshop?",
      answer:
        "De eerste programmeerconcepten, zoals een vaste volgorde van stappen en eenvoudige herhaling, landen doorgaans het beste vanaf groep 5. Groep 3-4 kan al wel kennismaken met besturing via simpele, grote knoppen of schakelaars, maar volledige blokprogrammeertaal is meestal nog te abstract op die leeftijd.",
    },
    {
      question: "Hoe voorkom je dat een techniekworkshop te moeilijk of te makkelijk is voor een groep?",
      answer:
        "Vraag de aanbieder vooraf concreet naar voorbeelden van wat de betreffende leeftijdsgroep gaat maken en hoeveel begeleiding daarbij nodig is. Een aanbieder die per leeftijdsfase een ander opdrachttype, andere groepsgrootte en andere lesduur hanteert, heeft daadwerkelijk gedifferentieerd; een uniform programma voor de hele school is een signaal dat dit niet is gebeurd.",
    },
    {
      question: "Kan een techniekworkshop worden gekoppeld aan de lesstof die de klas al behandelt?",
      answer:
        "Ja, bij Little Engineers Academy passen veel ateliers zich aan op het onderwerp dat een groep behandelt, bijvoorbeeld da Vinci's mechanische leeuw en Heron van Alexandrië's stoomdeuren bij geschiedenis, dieren-animaties bij biologie, en werkende windmolens bij aardrijkskunde of Nederlandse cultuur. Zo staat de workshop niet los van het curriculum maar versterkt het juist.",
    },
    {
      question: "Hoeveel begeleiders zijn er nodig bij een techniekworkshop voor groep 3-4?",
      answer:
        "Voor groep 3-4 wordt over het algemeen een groepsgrootte van acht tot tien kinderen per begeleider aangeraden, omdat jonge kinderen vaker individuele hulp nodig hebben bij het interpreteren van een volgende bouwstap. Bij grotere groepen zonder extra begeleiding neemt de kans op afhakers duidelijk toe.",
    },
    {
      question: "Is maker education vooral geschikt voor de bovenbouw, of ook voor jonge kinderen?",
      answer:
        "Maker education is geschikt voor alle leeftijden van het basisonderwijs, mits de opdracht is aangepast: grote, grijpbare onderdelen en korte, verhalende opdrachten voor groep 3-4, en complexere, van nul opgebouwde constructies voor groep 7-8. Het onderliggende principe - zelf bouwen, testen en bijstellen - werkt op elke leeftijd, alleen de vorm verschilt.",
    },
    {
      question: "Wat is TalentLAB en vanaf welke leeftijd is dat zinvol?",
      answer:
        "TalentLAB is een optionele wetenschappelijke talentanalyse op 70 parameters die inzicht geeft in de sterke kanten van een kind. Het is met name zinvol vanaf groep 5, wanneer kinderen bewuster kunnen reflecteren op hun eigen werkwijze, al kan het ook bij oudere kinderen in de bovenbouw waardevolle inzichten opleveren voor loopbaanoriëntatie.",
    },
  ],
  relatedProgram: { href: "/voor-scholen", label: "Voor scholen — ons aanbod" },
  furtherReading: [
    {
      slug: "steam-workshops-basisonderwijs-gids",
      title: "STEAM-workshops voor het basisonderwijs: de complete gids voor leerkrachten",
    },
    {
