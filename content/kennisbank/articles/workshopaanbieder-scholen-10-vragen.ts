...
const article: Article = {
  ...
  title: "De beste workshopaanbieder voor scholen kiezen: 10 vragen die je moet stellen",
  description:
    "De beste workshopaanbieder voor scholen herkent u aan 10 concrete vragen: VOG, verzekering, kerndoelen, groepsgrootte, offerte, subsidie en evaluatie.",
  category: "Voor scholen",
  readTime: "12 min",
  image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=900&q=80",
  imageAlt: "Schoolleider en workshopbegeleider bespreken een offerte en kennismaking aan een tafel op school",
  intro:
  ...
  tables: [
    ...
    {
      title: "De 10 vragen voor scholen in één overzicht",
      headers: ["#", "Vraag aan de aanbieder", "Waarom dit relevant is voor uw school"],
      rows: [
    ...
    {
      title: "Signalen van een sterke versus een zwakke aanbieder",
      headers: ["Onderdeel", "Sterke aanbieder", "Zwakke aanbieder"],
      rows: [
  ...
  checklist: {
    title: "Checklist: 10 vragen aan elke workshopaanbieder voor uw school",
    items: [
      "Hebben alle begeleiders die bij ons over de vloer komen een geldige VOG?",
      "Is er een aansprakelijkheidsverzekering die dekking biedt tijdens schooltijd?",
      "Sluit de workshop aan op onze kerndoelen en de leerlijn van dat moment?",
      "Is de aanbieder flexibel in groepsgrootte, van hele klas tot kleine groepjes?",
      "Hoe verlopen het offerte- en factuurproces precies?",
      "Zijn er subsidiemogelijkheden waarvan de aanbieder op de hoogte is?",
      "Kunnen wij referenties van andere scholen opvragen?",
      "Wat gebeurt er bij ziekte of uitval van de ingeplande begeleider?",
      "Wie verzorgt de materiaallevering en het opruimen na de workshop?",
      "Hoe en wanneer wordt de workshop na afloop geëvalueerd?",
    ],
  },
  observation:
  ...
  faqs: [
    {
      question: "Moeten wij als school altijd zelf om een VOG vragen, ook bij een bekende aanbieder?",
      answer:
        "Ja, vraag dit bij elke aanbieder, ook bij een partij die al jaren met scholen werkt. Een VOG kan verlopen zijn of alleen voor bepaalde begeleiders gelden, en een professionele aanbieder toont deze zonder aarzeling of legt het schriftelijk vast.",
    },
    {
      question: "Kunnen wij een schoolworkshop combineren met een subsidie zoals de Rijke Schooldag-regeling?",
      answer:
        "Dat kan bij veel aanbieders die ervaring hebben met scholen, maar vraag dit altijd na. Een goede aanbieder kan meedenken over de aanvraag en levert desgevraagd een heldere beschrijving van de workshop en de verwachte opbrengst aan.",
    },
    {
      question: "Wat als de workshop niet lijkt aan te sluiten op onze eigen methode of leerlijn?",
      answer:
        "Vraag de aanbieder vooraf hoe zij de inhoud aanpassen aan wat uw groep op dat moment behandelt, met een concreet voorbeeld. Een aanbieder die hierover vooraf met de leerkracht in gesprek gaat, kan de workshop meestal wel laten aansluiten op uw leerlijn.",
    },
    {
      question: "Hoeveel tijd moeten wij als school inplannen om een aanbieder goed te screenen op deze 10 vragen?",
      answer:
        "Reken op een kennismakingsgesprek van 20 tot 30 minuten, waarin u deze tien vragen natuurlijk in het gesprek verwerkt. Vraag om een schriftelijke bevestiging van de belangrijkste antwoorden, zeker rond VOG, verzekering en het offerteproces.",
    },
    {
      question: "Is een projectweek voor de hele school organisatorisch anders dan een losse workshop voor één klas?",
      answer:
        "Ja, bij een projectweek is het extra belangrijk te vragen naar de planning met meerdere groepen, het aantal begeleiders per dag en één vast aanspreekpunt dat de hele week coördineert. Dit voorkomt dat elke leerkracht apart moet schakelen met een andere begeleider.",
    },
    {
      question: "Werkt Little Engineers Academy alleen in Brainport Eindhoven, of ook op andere scholen in Nederland?",
      answer:
        "Little Engineers Academy is gevestigd in Eindhoven en Eersel, in het hart van Brainport Eindhoven, maar het team komt ook op locatie bij scholen door heel Nederland. Vraag bij de kennismaking naar de mogelijkheden en planning voor uw specifieke regio.",
    },
  ],
